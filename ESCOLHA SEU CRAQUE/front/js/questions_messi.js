const card_messi_question = document.querySelector('.card_face-front-m h2');

card_messi_question.addEventListener('click', function () {
    ...
    var imprimir = document.getElementById('imprimir_m');
